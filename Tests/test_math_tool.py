...
class TestMathTool(unittest.TestCase):
    ...
    def test_calculate_one_way_distance_correct_output(self):
        ...
        image2 = [[0, 1], [1, 0]]
        expected_output = 1
        result = MathTool.calculate_one_way_distance(coords1, coords2, image1, image2,neighbors_offset)
    ...
    def test_calculate_sum_of_distances_correct_output(self):
        ...
        result = MathTool.calculate_sum_of_distances(coords1, coords2, image1, image2,neighbors_offset)
        self.assertAlmostEqual(result, expected_output, places=6)
    ...
    def test_neighbors_positive(self):
        ...
        self.assertEqual(MathTool.neighbors_positive(coords1, image1, image2,neighbors_offset),execpted_output)
        coords1 = (1, 1)
